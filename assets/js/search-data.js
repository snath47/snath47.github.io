...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "CV",
          description: "Data Science MSc candidate at FAU with expertise in Machine Learning, Efficient and Brain Inspired AI, Neuronal Dynamics and Reinforcement Learning. Download my full CV below.",
          section: "Navigation",
          handler: () => {
        ...
        section: 'Socials',
        handler: () => {
          window.open("/assets/pdf/resume_academic.pdf", "_blank");
        },
      },{
        id: 'social-email',
        title: 'email',
        section: 'Socials',
        handler: () => {
          window.open("mailto:%73%61%6E%64%69%70%61%6E.%6E%61%74%68@%66%61%75.%64%65", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/snath47", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/sandipan-nath", "_blank");
        },
      },{
      id: 'light-theme',
